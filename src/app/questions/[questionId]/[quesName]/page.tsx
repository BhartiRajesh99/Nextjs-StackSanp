...
const Page = async ({
  ...
  return (
    <TracingBeam className="container pl-10">
      <div className="relative mx-auto px-10 pb-20 pt-36">
        <div className="flex">
        ...
        <div className="flex gap-4">
          ...
          <div className="w-full overflow-auto">
            ...
            <div className="mt-3 px-4 flex flex-wrap items-center gap-3 text-sm">
            ...
            <div className="mt-4 px-4 flex items-center justify-end gap-1">
              <picture>
                <img
